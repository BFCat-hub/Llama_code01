...
__global__ void nlf_filter_up_backward(const int n, const float *bottom_data, const float *top_data,
...
int main() {
    ...
    nlf_filter_up_backward<<<gridDim, blockDim>>>(n, bottom_data_device, top_data_device,
