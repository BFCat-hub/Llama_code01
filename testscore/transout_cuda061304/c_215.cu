...
__global__ void doubleArrayScalarSubstractKernel(double* d_in, double* d_out, int length, double scalar) {
...
int main() {
    ...
    doubleArrayScalarSubstractKernel<<<gridSize, blockSize>>>(d_d_in, d_d_out, arraySize, h_scalar);
